...
object KokoroEnglishPhonemizer {
    ...
    fun phonemizeToTokens(
        ...
        if (unknownWords.size > maxOf(3, wordCount / 3)) return null
...
private val tokenIds: Map<Char, Int> = mapOf(
    ...
    ' ' to 16, 'A' to 24, 'I' to 25, 'O' to 31, 'Q' to 33, 'S' to 35,
    'T' to 36, 'W' to 39, 'Y' to 41, 'ᵊ' to 42, 'a' to 43, 'b' to 44,
    'c' to 45, 'd' to 46, 'e' to 47, 'f' to 48, 'h' to 50, 'i' to 51,
    'j' to 52, 'k' to 53, 'l' to 54, 'm' to 55, 'n' to 56, 'o' to 57,
    'p' to 58, 'q' to 59, 'r' to 60, 's' to 61, 't' to 62, 'u' to 63,
    'v' to 64, 'w' to 65, 'x' to 66, 'y' to 67, 'z' to 68, 'ɑ' to 69,
    'ɐ' to 70, 'ɒ' to 71, 'æ' to 72, 'ɔ' to 76, 'ð' to 81, 'ʤ' to 82,
    'ə' to 83, 'ɚ' to 85, 'ɛ' to 86, 'ɜ' to 87, 'ɡ' to 92, 'ɪ' to 102,
    'ŋ' to 112, 'θ' to 119, 'ɹ' to 123, 'ɾ' to 125, 'ʃ' to 131, 'ʧ' to 133,
    'ʊ' to 135, 'ʌ' to 138, 'ʒ' to 147, 'ʔ' to 148, 'ˈ' to 156, 'ˌ' to 157,
    'ː' to 158, 'ᵻ' to 177
)
